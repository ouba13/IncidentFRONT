...
@Component({
  selector: 'app-ticket-list-declarant',
  templateUrl: './ticket-list-declarant.component.html',
  styleUrls: ['./ticket-list-declarant.component.css']
})
export class TicketListDeclarantComponent {
  Tickets!: any;
  ...
  viewTicketDetail(id : number){
   this.router.navigate(['declarantComp/view-ticket' , id]);
  }

  ajoutTicket(){
    this.router.navigate(['declarantComp/ajoutTicket-dec']);
  }

  updateTicket(id:number){
    this.router.navigate(['declarantComp/update-ticket',id]);
  }
